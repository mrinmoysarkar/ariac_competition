...
if("TRUE" STREQUAL "TRUE")
  set(ur_msgs_SOURCE_PREFIX /home/mrinmoy/ariac_competition/ur10_moveit_ws/src/ur_msgs)
  set(ur_msgs_DEVEL_PREFIX /home/mrinmoy/ariac_competition/ur10_moveit_ws/devel/.private/ur_msgs)
  set(ur_msgs_INSTALL_PREFIX "")
  set(ur_msgs_PREFIX ${ur_msgs_DEVEL_PREFIX})
else()
  set(ur_msgs_SOURCE_PREFIX "")
  set(ur_msgs_DEVEL_PREFIX "")
  set(ur_msgs_INSTALL_PREFIX /home/mrinmoy/ariac_competition/ur10_moveit_ws/install)
...
if(NOT "/home/mrinmoy/ariac_competition/ur10_moveit_ws/devel/.private/ur_msgs/include " STREQUAL " ")
  set(ur_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/mrinmoy/ariac_competition/ur10_moveit_ws/devel/.private/ur_msgs/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Alexander Bubeck <aub@ipa.fhg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mrinmoy/ariac_competition/ur10_moveit_ws/src/ur_msgs/${idir}'.  Ask the maintainer 'Alexander Bubeck <aub@ipa.fhg.de>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mrinmoy/ariac_competition/ur10_moveit_ws/devel/.private/ur_msgs/lib;/home/mrinmoy/ariac_competition/ur10_moveit_ws/devel/lib;/opt/ros/indigo/lib)
