...
if("TRUE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /home/mrinmoy/ariac_competition/ur10_moveit_ws/src/ur_gazebo)
  set(ur_gazebo_DEVEL_PREFIX /home/mrinmoy/ariac_competition/ur10_moveit_ws/devel/.private/ur_gazebo)
  ...
  set(ur_gazebo_INSTALL_PREFIX /home/mrinmoy/ariac_competition/ur10_moveit_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Alexander Bubeck <aub@ipa.fhg.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mrinmoy/ariac_competition/ur10_moveit_ws/src/ur_gazebo/${idir}'.  Ask the maintainer 'Alexander Bubeck <aub@ipa.fhg.de>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mrinmoy/ariac_competition/ur10_moveit_ws/devel/.private/ur_gazebo/lib;/home/mrinmoy/ariac_competition/ur10_moveit_ws/devel/lib;/opt/ros/indigo/lib)
